...
serve(async (req) => {
  ...
  if (isPentestMode()) return pentestSkipResponse("unread-message-notifications", corsHeaders);


  // SECURITY: Require shared CRON secret. Triggers bulk email to real users.

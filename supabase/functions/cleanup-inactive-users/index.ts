...
Deno.serve(async (req) => {
  ...
  // SECURITY: Require a shared CRON secret. This function uses the service role key
  // and performs destructive bulk auth.admin.deleteUser() calls, so it must never
  // be invokable by anonymous callers.

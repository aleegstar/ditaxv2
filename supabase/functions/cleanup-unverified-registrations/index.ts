...
Deno.serve(async (req) => {
  ...
  // SECURITY: Require shared CRON secret. This function uses the service role key,
  // can enumerate users by email, and deletes accounts. Must never be invokable by
  // anonymous callers.

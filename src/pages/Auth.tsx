...
const Auth = () => {
  ...
  return <div className="min-h-screen bg-white text-slate-900 antialiased selection:bg-[#1D64FF]/30 overflow-hidden relative">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0 hidden sm:block">
        ...
        <div className="absolute -bottom-32 right-1/4 w-80 h-80 bg-cyan-100 rounded-full blur-3xl mix-blend-multiply opacity-70" />
        <div className="absolute -top-16 right-1/3 w-96 h-96 bg-indigo-100 rounded-full blur-3xl mix-blend-multiply opacity-70" />
      </div>
          ...
          <AnimatePresence mode="wait">
            {step === "main" ? <motion.div key="main-step" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.3 }}>
                ...
                <form onSubmit={handleEmailSubmit} className="space-y-6">
                  ...
                  <button type="submit" disabled={isLoading} className="flex w-full items-center justify-center rounded-2xl bg-slate-100 py-4 text-lg font-semibold text-slate-800 shadow-inner shadow-slate-200/60 border border-slate-200/50 hover:bg-slate-200/70 active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-slate-300 focus:ring-offset-2 focus:ring-offset-white transition-all duration-200 disabled:opacity-50 disabled:pointer-events-none">
                ...
                <div className="space-y-4">
                  {/* Google */}
                  <button onClick={handleGoogleAuth} disabled={isLoading} className="flex w-full items-center justify-center gap-3 rounded-2xl bg-slate-100 py-4 px-4 text-base font-semibold text-slate-800 shadow-inner shadow-slate-200/60 border border-slate-200/50 transition-all hover:bg-slate-200/70 active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-slate-300 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none group">
                  ...
                  {/* Apple */}
                  <button onClick={handleAppleAuth} disabled={isLoading} className="flex w-full items-center justify-center gap-3 rounded-2xl bg-slate-100 py-4 px-4 text-base font-semibold text-slate-800 shadow-inner shadow-slate-200/60 border border-slate-200/50 transition-all hover:bg-slate-200/70 active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-slate-300 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none group">

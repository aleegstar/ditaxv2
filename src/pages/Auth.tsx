              ...
              {step === "main" ? <motion.div key="main-step" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} transition={{ duration: 0.3, ease: [0.25, 0.1, 0.25, 1] }}>
                  ...
                  <div className="flex flex-col gap-2.5 w-full mb-7">
                    ...
                    <motion.button
                      ...
                      className="group w-full text-foreground font-medium text-[14.5px] tracking-tight h-[56px] px-7 rounded-2xl border border-black/10 flex items-center justify-center gap-3 disabled:opacity-50 disabled:pointer-events-none"
                      style={{
                        background: '#ffffff',
                        boxShadow:
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      transition={{ type: 'spring', stiffness: 400, damping: 28 }}
                      className="group w-full font-medium text-[14.5px] tracking-tight h-[56px] px-7 rounded-2xl border border-white/10 flex items-center justify-center gap-3 disabled:opacity-50 disabled:pointer-events-none text-white"
                      style={{

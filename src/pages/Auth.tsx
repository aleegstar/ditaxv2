            ...
            <AnimatePresence mode="wait">
              {step === "main" ? <motion.div key="main-step" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} transition={{ duration: 0.3, ease: [0.25, 0.1, 0.25, 1] }}>
                  ...
                  <div className="flex flex-col items-center text-center mb-8">
                    <motion.img
                      alt="Ditax"
                      className="w-auto h-6 object-contain mb-7"
                    ...
                    <p className="text-[13.5px] tracking-tight text-muted-foreground/70 font-normal">
                  ...
                  <div className="flex flex-col gap-2 w-full mb-6">
                    ...
                    <button
                      ...
                      disabled={isLoading}
                      className="group w-full bg-white text-foreground font-medium text-[14px] tracking-tight h-12 px-5 rounded-xl border border-black/[0.09] flex items-center justify-center gap-2.5 disabled:opacity-50 disabled:pointer-events-none transition-all hover:border-black/[0.16] hover:bg-foreground/[0.015] active:scale-[0.99]"
                    >
                    ...
                    <button
                      ...
                      className="group w-full bg-white text-foreground font-medium text-[14px] tracking-tight h-12 px-5 rounded-xl border border-black/[0.09] flex items-center justify-center gap-2.5 disabled:opacity-50 disabled:pointer-events-none transition-all hover:border-black/[0.16] hover:bg-foreground/[0.015] active:scale-[0.99]"
                    >
                      <svg className="w-[17px] h-[17px] shrink-0 fill-foreground" viewBox="0 0 24 24">
                  ...
                  <div className="w-full flex items-center gap-4 mb-6 px-1">
                    ...
                    <span className="text-[10px] font-semibold text-muted-foreground/45 uppercase tracking-[0.2em]">{t.authFlow.or}</span>
                    <div className="h-px flex-1 bg-black/[0.07]" />
                  </div>
                  ...
                  <div className="mt-8 flex flex-col items-center gap-3 text-center">
                    <p className="text-[13px] text-muted-foreground/60 font-light">
                      ...
                      {resendCountdown > 0 ? <>
                          ...
                          <span className="ml-1 text-muted-foreground/40">({String(Math.floor(resendCountdown / 60)).padStart(2, '0')}:{String(resendCountdown % 60).padStart(2, '0')})</span>
                    ...
                    <button onClick={handleBackClick} className="flex items-center gap-1.5 text-[13px] text-muted-foreground/40 hover:text-foreground transition-colors mt-1">

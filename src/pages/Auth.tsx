...
const Auth = () => {
  ...
  return <div className="min-h-screen text-slate-900 antialiased selection:bg-[#1D64FF]/30 overflow-hidden relative" style={{ background: 'linear-gradient(135deg, #e0e7ff 0%, #f0f4ff 25%, #faf5ff 50%, #ecfdf5 75%, #e0f2fe 100%)' }}>
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center p-0 sm:p-6 lg:p-8">
        ...
        {/* Card: Liquid Glass */}
        <div className="w-full min-h-screen sm:min-h-0 max-w-lg rounded-none sm:rounded-3xl border-0 sm:border sm:border-white/40 px-6 py-10 sm:p-12 sm:shadow-2xl sm:shadow-black/5" style={{ background: 'rgba(255,255,255,0.55)', backdropFilter: 'blur(40px) saturate(180%)', WebkitBackdropFilter: 'blur(40px) saturate(180%)' }}>
                ...
                <form onSubmit={handleEmailSubmit} className="space-y-6">
                  <div>
                    ...
                    <div className="relative group">
                      ...
                      <input type="email" name="email" id="email" value={email} onChange={(e) => setEmail(e.target.value)} onFocus={() => setIsInputFocused(true)} onBlur={() => setTimeout(() => setIsInputFocused(false), 150)} className="block w-full rounded-2xl border border-white/50 py-4 pl-12 pr-4 text-lg text-slate-900 placeholder:text-slate-400 focus:border-white/70 focus:outline-none focus:ring-4 focus:ring-white/20 transition-all" style={{ background: 'rgba(255,255,255,0.5)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)' }} placeholder={t.authFlow.emailPlaceholder} aria-label={t.authFlow.emailPlaceholder} required disabled={isLoading} />
                    </div>
                  </div>

                  <button type="submit" disabled={isLoading} className="flex w-full items-center justify-center rounded-2xl py-4 text-lg font-semibold text-white border border-white/20 hover:-translate-y-0.5 active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-white/30 focus:ring-offset-2 focus:ring-offset-transparent transition-all duration-200 disabled:opacity-50 disabled:pointer-events-none" style={{ background: 'linear-gradient(135deg, rgba(59,130,246,0.85) 0%, rgba(99,102,241,0.85) 100%)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', boxShadow: '0 8px 32px rgba(59,130,246,0.3), inset 0 1px 0 rgba(255,255,255,0.2)' }}>
                  ...
                  <div className="flex justify-between gap-2">
                    <InputOTP value={code} onChange={handleCodeChange} maxLength={6}>
                      <InputOTPGroup className="flex justify-between gap-2 w-full">
                         <InputOTPSlot index={0} className="w-full h-14 text-center text-xl font-semibold border border-white/50 rounded-2xl focus:outline-none focus:ring-4 focus:ring-white/20 focus:border-white/70 transition-all text-slate-900" style={{ background: 'rgba(255,255,255,0.5)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)' }} />
                         <InputOTPSlot index={1} className="w-full h-14 text-center text-xl font-semibold border border-white/50 rounded-2xl focus:outline-none focus:ring-4 focus:ring-white/20 focus:border-white/70 transition-all text-slate-900" style={{ background: 'rgba(255,255,255,0.5)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)' }} />
                         <InputOTPSlot index={2} className="w-full h-14 text-center text-xl font-semibold border border-white/50 rounded-2xl focus:outline-none focus:ring-4 focus:ring-white/20 focus:border-white/70 transition-all text-slate-900" style={{ background: 'rgba(255,255,255,0.5)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)' }} />
                         <InputOTPSlot index={3} className="w-full h-14 text-center text-xl font-semibold border border-white/50 rounded-2xl focus:outline-none focus:ring-4 focus:ring-white/20 focus:border-white/70 transition-all text-slate-900" style={{ background: 'rgba(255,255,255,0.5)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)' }} />
                         <InputOTPSlot index={4} className="w-full h-14 text-center text-xl font-semibold border border-white/50 rounded-2xl focus:outline-none focus:ring-4 focus:ring-white/20 focus:border-white/70 transition-all text-slate-900" style={{ background: 'rgba(255,255,255,0.5)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)' }} />
                         <InputOTPSlot index={5} className="w-full h-14 text-center text-xl font-semibold border border-white/50 rounded-2xl focus:outline-none focus:ring-4 focus:ring-white/20 focus:border-white/70 transition-all text-slate-900" style={{ background: 'rgba(255,255,255,0.5)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)' }} />
                      </InputOTPGroup>
                    </InputOTP>
                  </div>

                  <button onClick={handleWeiterClick} disabled={isLoading || code.length !== 6} className="flex w-full items-center justify-center rounded-2xl py-4 text-lg font-semibold text-white border border-white/20 hover:-translate-y-0.5 active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-white/30 focus:ring-offset-2 focus:ring-offset-transparent transition-all duration-200 disabled:opacity-50 disabled:pointer-events-none" style={{ background: 'linear-gradient(135deg, rgba(59,130,246,0.85) 0%, rgba(99,102,241,0.85) 100%)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', boxShadow: '0 8px 32px rgba(59,130,246,0.3), inset 0 1px 0 rgba(255,255,255,0.2)' }}>

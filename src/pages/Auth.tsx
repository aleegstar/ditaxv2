...
const Auth = () => {
  ...
  return <div className="min-h-screen bg-white text-slate-900 antialiased selection:bg-blue-500/30 overflow-hidden relative">

      {/* Subtle gradient background - desktop only */}
      <div className="absolute inset-0 pointer-events-none z-0 hidden sm:block">
        <div className="absolute -top-24 left-1/4 w-96 h-96 bg-blue-50 rounded-full blur-3xl opacity-60" />
        <div className="absolute -bottom-32 right-1/4 w-80 h-80 bg-cyan-50 rounded-full blur-3xl opacity-50" />
        <div className="absolute -top-16 right-1/3 w-96 h-96 bg-indigo-50 rounded-full blur-3xl opacity-50" />
      </div>
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center p-0 sm:p-6 lg:p-8">
        ...
        {/* Card */}
        <div className="w-full min-h-screen sm:min-h-0 max-w-md sm:rounded-3xl sm:border sm:border-slate-200 bg-white sm:shadow-2xl sm:shadow-slate-200/50">

          <div className="flex flex-col justify-between min-h-screen sm:min-h-0 px-6 pt-14 pb-6 sm:p-10">
          <AnimatePresence mode="wait">
            {step === "main" ? <motion.div key="main-step" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.3 }} className="flex flex-col flex-1">
                ...
                <div className="flex-1">
                  ...
                  <form onSubmit={handleEmailSubmit} className="space-y-4">
                    ...
                    <motion.button
                      ...
                      className="flex w-full items-center justify-center rounded-xl bg-blue-600 py-3.5 text-base font-semibold text-white shadow-md shadow-blue-600/20 hover:bg-blue-700 active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 disabled:opacity-40 disabled:pointer-events-none"
                      whileTap={{ scale: 0.98 }}
                    >
                      {isEmailLoading ? (
                  ...
                  <div className="space-y-3">
                    <button onClick={handleGoogleAuth} disabled={isLoading} className="flex w-full items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white py-3 px-4 text-sm font-medium text-slate-600 transition-all hover:bg-slate-50 hover:border-slate-300 active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-slate-200 focus:ring-offset-1 disabled:opacity-50 disabled:pointer-events-none">
                    ...
                    <button onClick={handleAppleAuth} disabled={isLoading} className="flex w-full items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white py-3 px-4 text-sm font-medium text-slate-600 transition-all hover:bg-slate-50 hover:border-slate-300 active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-slate-200 focus:ring-offset-1 disabled:opacity-50 disabled:pointer-events-none">

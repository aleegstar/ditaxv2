  ...
  if (isLoading) {
    return (
      <div className="container mx-auto p-6">
        <div className="text-center">Lade Tickets...</div>
      </div>
    );
  }
      ...
      {tickets.length === 0 ? (
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Keine Tickets vorhanden</h3>
            <p className="text-gray-600">Du hast noch keine Support-Tickets erstellt.</p>
          </CardContent>
        </Card>
      ) : (
        <div className="space-y-4">
          <h2 className="text-lg font-semibold text-gray-900">Deine Tickets</h2>
          {tickets.map((ticket) => (
            <Card key={ticket.id}>

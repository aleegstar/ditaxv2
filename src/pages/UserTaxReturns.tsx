      ...
      <main className="min-h-screen sm:px-6 lg:px-8 max-w-7xl mr-auto ml-auto pt-6 pr-4 pl-4 relative">
        ...
        <section className="flex pb-10 items-end justify-between">
          <div className="flex flex-col gap-1">
            <p className="text-base font-medium text-gray-500 font-jakarta">
              {getGreeting()}
            </p>
            <h1 className="text-4xl text-gray-900 font-medium tracking-tight font-jakarta leading-none">
              {getUserDisplayName()}
            </h1>
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative h-64 w-full rounded-[2rem] overflow-hidden bg-blue-600 flex items-center justify-center">
                  <span className="text-8xl font-semibold text-white tracking-tight font-jakarta transition-transform duration-500 group-hover:scale-110">
                    {year}
                  </span>
              ...
              >
                ...
                <div className="px-2 pt-6 pb-0 flex flex-col">
                  ...
                  <p className="text-gray-400 text-[15px] leading-relaxed font-jakarta">
                    Bescheid vom {existingReturn?.updated_at 
      ...
      <div className="fixed bottom-6 left-0 right-0 z-50 flex justify-center pointer-events-none">
        <div className="pointer-events-auto flex items-center p-1.5 gap-2 bg-white/90 backdrop-blur-xl border border-gray-200 rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
          ...
          <button 
            ...
            className="flex items-center gap-3 pl-2 pr-5 py-2 rounded-full hover:bg-gray-100 transition-colors group"
          >
          ...
          <button 
            ...
            className="p-3 text-gray-500 rounded-full hover:text-gray-900 hover:bg-gray-100 transition-colors relative"
          >
          ...
          <button 
            ...
            className="p-3 text-gray-500 rounded-full hover:text-gray-900 hover:bg-gray-100 transition-colors"
          >

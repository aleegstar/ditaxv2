      ...
      <div className="overflow-hidden min-h-screen md:max-w-2xl w-full max-w-[430px] mx-auto relative">
        ...
        >
          ...
          <div className="relative w-full flex justify-center items-end pb-0 pointer-events-auto">
            ...
            <button onClick={handleDocumentsClick} data-tour="floating-document-button" className="group relative w-full h-24 bg-gradient-to-t from-[#060609] to-[#13131a] border-t border-white/10 flex flex-col items-center justify-start pt-4 transition-all duration-300 overflow-visible rounded-t-[50%] hover:h-28">

    ...
    <div className="min-h-screen text-foreground antialiased">
      ...
      {showCompletionDialog && (
        <div className="fixed inset-0 z-[10010]">
          ...
          />
          <div className="absolute left-1/2 -translate-x-1/2 bottom-2 md:bottom-auto md:top-1/2 md:-translate-y-1/2 bg-card shadow-[0_-10px_40px_-10px_rgba(0,0,0,0.15)] md:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.25)] pb-8 md:pb-6 overflow-hidden w-[calc(100%-1rem)] md:w-[min(560px,calc(100vw-2rem))] md:max-h-[85vh] md:overflow-y-auto rounded-[28px] md:rounded-3xl animate-in slide-in-from-bottom md:slide-in-from-bottom-0 md:fade-in-0 md:zoom-in-95 duration-400" style={{ marginBottom: 'env(safe-area-inset-bottom, 0px)' }}>

...
export function AdminSidebar() {
  ...
  return (
    <div 
      data-sidebar 
      className="h-full flex-shrink-0 w-[260px] flex flex-col relative min-h-0 border-r border-border/60 bg-card/50 justify-between"
    >
      <div className="flex flex-col h-full overflow-hidden px-4 pt-6">
        {/* Logo Header */}
        <div className="flex items-center mb-8 px-3">
          <img src="/ditax-logo-new.svg" alt="Ditax" className="h-6 w-auto opacity-90" />
        </div>

        {/* Navigation */}
        <nav className="flex-1 overflow-y-auto overflow-x-hidden space-y-5 pr-1">
          <div className="space-y-0.5">

...
const ModeCard: React.FC<{
  ...
  cta: string;
  onClick: () => void;
}> = ({ image, imageAlt, icon, badge, title, desc, cta, onClick }) => (
  <button
    type="button"
    onClick={onClick}
    className="group text-left rounded-2xl border border-border bg-card overflow-hidden transition-all hover:shadow-[0_8px_24px_rgba(15,27,61,0.08)] hover:border-primary/30 focus:outline-none focus:ring-2 focus:ring-primary/30 flex flex-col"
  >

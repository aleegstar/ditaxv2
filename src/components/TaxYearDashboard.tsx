      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 space-y-6 pb-24 pt-2">
        ...
        {allAngabenComplete && !isAngabenExpanded ? (
          ...
          <div 
            ...
            className="bg-white p-6 rounded-[1.5rem] ring-1 ring-slate-200/60 flex items-center gap-4 transition-all duration-300 cursor-pointer shadow-[0_4px_14px_0_rgba(100,116,139,0.12),0_20px_40px_-12px_rgba(0,0,0,0.06)] hover:shadow-[0_6px_20px_rgba(100,116,139,0.18)] hover:-translate-y-0.5"
          >
          ...
          /* Expanded Card View */
          <section data-tour="form-step-1" className={`bg-white rounded-[1.5rem] ring-1 overflow-hidden relative transition-all duration-300 ${
          !allAngabenComplete 
        ...
        <section className={`flex flex-col gap-4 ${!allAngabenComplete ? 'opacity-50 grayscale select-none cursor-not-allowed' : ''}`}>
          ...
          <div data-tour="form-step-2" onClick={() => allAngabenComplete && handleDocumentsClick()} className={`bg-white p-6 rounded-[1.5rem] ring-1 flex items-center gap-4 transition-all duration-300 relative overflow-hidden ${
          ...
          <div data-tour="form-step-3" onClick={() => canSubmit && handleSubmitClick()} className={`bg-white p-6 rounded-[1.5rem] ring-1 flex items-center gap-4 transition-all duration-300 relative overflow-hidden ${

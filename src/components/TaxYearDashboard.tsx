  ...
  const StepRow: React.FC<{
    ...
    if (state === 'active') {
      return (
        <div
          onClick={onAction}
          className="group cursor-pointer relative bg-card border-2 border-[#1450dc] shadow-[0_10px_40px_-12px_rgba(20,80,220,0.18)] rounded-[1.5rem] overflow-hidden transition-all duration-300 hover:shadow-[0_16px_50px_-12px_rgba(20,80,220,0.25)]"
        >

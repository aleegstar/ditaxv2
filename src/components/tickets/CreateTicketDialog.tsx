      ...
      <DialogContent className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100%-2rem)] max-w-md max-h-[90vh] bg-white border-0 p-0 overflow-hidden shadow-2xl rounded-3xl gap-0">
        {isComplete ? (
          ...
          <>
            ...
            <div className="bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 px-6 py-4">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="bg-white border-slate-200 min-h-[120px] rounded-xl text-slate-900 placeholder:text-slate-400 focus:border-blue-500 focus:ring-blue-500/20 resize-none"
                  required
                />
              </div>
              ...
              <div className="flex gap-3 pt-2">
                <Button
                  ...
                  variant="ghost"
                  onClick={handleClose}
                  className="flex-1 h-12 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-600 font-medium"
                >
                  Abbrechen
                </Button>
                <Button
                  ...
                  className="flex-1 h-12 rounded-xl bg-gradient-to-b from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-medium shadow-lg shadow-blue-500/25 transition-all active:scale-[0.98] disabled:opacity-50 disabled:shadow-none"
                >
                  {isSubmitting ? (
                    <>

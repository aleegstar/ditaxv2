          ...
          >
            <div className="max-w-2xl mx-auto flex items-center gap-3 pointer-events-auto">
              ...
              <div
                ...
                style={{
                  backgroundImage: 'linear-gradient(#fff,#fff), linear-gradient(#fff 50%, rgba(255,255,255,0.8) 80%, rgba(255,255,255,0.4)), linear-gradient(90deg, rgb(0,46,153), rgb(0,34,112), rgb(31,98,255), rgb(0,67,224), rgb(0,46,153))',
                }}
              >
                {/* Rainbow glow */}
                <span
                  ...
                  style={{
                    backgroundImage: 'linear-gradient(90deg, rgb(0,46,153), rgb(0,34,112), rgb(31,98,255), rgb(0,67,224), rgb(0,46,153))',
                  }}
                />

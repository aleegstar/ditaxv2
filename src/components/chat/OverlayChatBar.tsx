          ...
          >
            <div className="max-w-2xl mx-auto flex items-center gap-3 pointer-events-auto">
              ...
              >
                ...
                <span className="text-base flex-1 select-none font-medium tracking-tight bg-gradient-to-r from-white/60 via-white to-white/60 bg-[length:200%_100%] bg-clip-text text-transparent animate-[shimmer_3s_ease-in-out_infinite]">

...
export const ChatBotInterface: React.FC<ChatBotInterfaceProps> = ({
  ...
  return <>
      <div className="flex flex-col h-full relative overflow-hidden">
        ...
        <div
          className="z-20 p-4 w-full shrink-0 fixed bottom-0 left-0 right-0 pb-[var(--safe-area-bottom, env(safe-area-inset-bottom, 8px))] md:relative md:pb-4 bg-transparent"
        >

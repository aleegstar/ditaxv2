...
const DeductionsForm = ({
  ...
  const renderDeductionsForm = () => <ExpertFormContainer title={t.deductions.title} onBack={() => navigate(`/personal-info?year=${taxYear}`)} onSubmit={handleSubmit} submitLabel={t.forms.save} showFooter={!embedded}>
      {/* Checkbox List */}

    ...
    <>
      <SonnerToaster 
        ...
        toastOptions={{
          unstyled: true,
          classNames: {
            toast: "group flex items-center gap-2.5 w-full max-w-xs pl-3 pr-10 py-2.5 rounded-xl bg-zinc-800/95 backdrop-blur-sm shadow-lg font-['Plus_Jakarta_Sans',sans-serif] relative",

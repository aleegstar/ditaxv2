...
export function ProjectStatusCard({
  ...
  return (
    <Card
      className="w-full max-w-md cursor-pointer transition-all duration-300 hover:shadow-lg border-2 border-blue-500/20 bg-white"
    ...
    >
              ...
              <AnimatePresence>
                {isExpanded && (
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      <h4 className="font-medium text-sm text-blue-800">Recent Tasks</h4>
      ...
      <CardFooter>
        <div className="flex items-center justify-between w-full text-sm text-blue-600">

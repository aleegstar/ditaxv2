...
const EnhancedDocumentUploader: React.FC<DocumentUploaderProps> = ({
  ...
  return (
    <div className="min-h-full text-slate-800 antialiased selection:bg-indigo-100">
      ...
      {/* Bottom Action Area */}
      {hasValidFiles && (
        <div className="fixed bottom-0 left-0 w-full px-6 pb-6 pt-4 bg-gradient-to-t from-white via-white to-transparent z-30">
          <div className="w-full max-w-4xl mx-auto">
            ...
            >
              {/* Button */}
              <div className="relative w-full h-14 bg-gradient-to-b from-blue-500 to-blue-600 border-t border-blue-400 text-white rounded-2xl flex items-center justify-center gap-2.5 font-semibold text-[15px] hover:-translate-y-0.5 active:scale-[0.98] transition-all duration-200">
                {uploading ? (

          ...
          return (
            ...
            >
              ...
              {!isLast && (
                <div
                  className={cn(
                    'absolute left-[1.125rem] top-[2.5rem] bottom-[-0.25rem] w-[2px] z-0',
                    lineClass
                  )}
                />
              )}
              ...
              <div className="relative z-10 flex-shrink-0">
                {step.status === 'completed' ? (
                  ...
                  <div className="w-9 h-9 rounded-full bg-white border-[2.5px] border-blue-500 flex items-center justify-center shadow-lg shadow-blue-100 ring-4 ring-blue-50">
              ...
              {/* Text */}
              <div className={step.status === 'in_progress' ? 'pt-0.5 w-full' : 'pt-1'}>
                <div className="flex flex-wrap items-center gap-2 mb-1">
                  ...
                  {step.badge && (
                    <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium bg-orange-50 text-orange-600 border border-orange-100 tracking-wide">
                      {step.badge}
                    </span>
                  )}
                </div>

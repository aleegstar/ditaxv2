...
export const translations: Record<'de' | 'en', Translation> = {
  de: {
    ...
    assets: {
      ...
      propertyOlderThanFive: 'Ist die Liegenschaft mehr als 10 Jahre alt?',
    ...
    documentsPage: {
      ...
      upload: 'Hochladen',
      collectReceipts: 'Dokumente sammeln',
      collectReceiptsDescription: 'Lade hier deine Belege, Rechnungen und Quittungen hoch. Du kannst sie später bequem der Dokumentencheckliste deiner Steuererklärung zuteilen.',
    ...
    tour: {
      ...
      addYearTitle: 'Steuerjahre',
      addYearDescription: 'Hier wählst du das gewünschte Steuerjahr aus. Neue Jahre werden automatisch freigeschaltet.',
      chatTitle: 'Chat',
      chatDescription: 'Über den Chat-Tab erreichst du jederzeit unseren Support und unsere KI-Assistenz.',
  ...
  en: {
    ...
    assets: {
      ...
      propertyOlderThanFive: 'Is the property more than 10 years old?',
    ...
    documentsPage: {
      ...
      filterSort: 'Sort',
      upload: 'Upload',
      collectReceipts: 'Collect documents',
      collectReceiptsDescription: 'Upload your receipts, invoices and bills here. You can assign them to the document checklist of your tax return later.',
    ...
    tour: {
      ...
      addYearTitle: 'Tax Years',
      addYearDescription: 'Pick the tax year you want to work on. New years are unlocked automatically.',
      chatTitle: 'Chat',
      chatDescription: 'The Chat tab connects you to our support and AI assistant anytime.',

...
const UserTaxReturns = lazyWithRetry(() => import("./pages/UserTaxReturns"));
const Chat = lazyWithRetry(() => import("./pages/Chat"));
const UserDetail = lazyWithRetry(() => import("./pages/UserDetail"));
const Auth = lazyWithRetry(() => import("./pages/Auth"));
const GoogleAuth = lazyWithRetry(() => import("./pages/GoogleAuth"));
const AppleAuth = lazyWithRetry(() => import("./pages/AppleAuth"));
const WebAuthnAuth = lazyWithRetry(() => import("./pages/WebAuthnAuth"));
const AuthSuccess = lazyWithRetry(() => import("./pages/AuthSuccess"));
const NativeCallback = lazyWithRetry(() => import("./pages/NativeCallback"));
...
const PaymentPage = lazyWithRetry(() => import("./pages/Payment"));
...
const TaxReturnTracking = lazyWithRetry(() => import("./pages/TaxReturnTracking"));
const TaxReturnActions = lazyWithRetry(() => import("./pages/TaxReturnActions"));
const TaxFilers = lazyWithRetry(() => import("./pages/TaxFilers"));
...
const DevAgImport = lazyWithRetry(() => import("./pages/DevAgImport"));
